...
<div className="flex flex-grow md:ms-96 ms-10 mt-3">
    <a href="https://www.instagram.com/sabrina_kitaka/?hl=en" target="_blank" className="items-center text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700">
    ...
    <a href="https://twitter.com/SabrinaKitaka" className="items-center text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700" target="_blank">
  <svg
...
<a href="mailto:sabrinakitaka@gmail.com" className="items-center text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700" target="_blank">
<svg xmlns="http://www.w3.org/2000/svg"  className="ms-1 h-10 w-10"
    ...
    <div style={bottomImage} className="bg-red-500 w-screen h-20 mt-20">
    </div>
    </div>
    )
}
