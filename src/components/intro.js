...
export default function Intro() {
 return (
    <div className="grid md:grid-cols-2 gap-3">
        ...
        <button className="bg-red-500 hover:bg-red-700 py-2 px-4 rounded ">Projects</button>&nbsp;<button className="border-2 border-black-500 text-black rounded py-2 px-4">LinkedIn</button>
        </div>
        <div>
        </div>
    </div>
